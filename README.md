...
2. Dataset	45 chỉ số và tỷ lệ tài chính của tất cả các công ty thuộc chỉ số Nasdaq-100 trong trong giai đoạn từ năm 2017 đến 2022, nguồn Kaggle		
...
3. Các vấn đề của dataset gốc 	Có nhiều thuộc tính dữ liệu không đầy đủ tất cả các năm.		
...
4. Các chỉ số và tỷ lệ:
  1	Vòng quay tài sản	Asset Turnover
	...
	8	Chỉ số Altman Z-Score	Altman Z-Score
	9	Tỷ lệ thanh toán hiện hành (Current Ratio)	Current Ratio
